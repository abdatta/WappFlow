  ...
  return (
    <div className="min-h-screen flex flex-col">
      <nav className="bg-gray-800 px-4 py-3 flex gap-4">
        ...
        <NavLink to="/send" className={navClasses}>Send</NavLink>
        <NavLink to="/scheduling" className={navClasses}>Scheduling</NavLink>
        <NavLink to="/alerts" className={navClasses}>Alerts</NavLink>
        <NavLink to="/qr" className={navClasses}>QR</NavLink>
      </nav>
